...
export default function Topbar() {
  ...
  {/* LEFT SIDE (from small file - clean) */}
  <div>
  ...
  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
    ...
    {/* 🔔 Notification Bell (big file logic stays) */}
    <div style={{ position: 'relative' }} ref={dropdownRef}>
      ...
      >
        <i className="fas fa-bell"
          style={{
            fontSize: '1rem',
            color: unread > 0 ? 'var(--orange)' : 'var(--text2)'
          }}
        ></i>
      ...
      {/* Dropdown stays same (no change needed) */}
      {showDropdown && (
        <div style={{
          position: 'absolute',
          top: '52px',
